-- Client operations Supabase schema.
-- Mirrors the blueprint in guides/client-ops-supabase-schema.sql.
-- V1 prototype data still lives in app/lib/clientPortal.ts; this migration is
-- safe to apply on an empty project before any row writes are wired up.
